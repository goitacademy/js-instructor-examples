...
## Задача 6 - Методы строк и чейнинг
...
## Задача 7 - Операторы сравнения и приведение типов
...
## Задача 9 - Значение по умолчанию и оператор нулевого слияния
...
## Задача 10 - Опертор % и методы строк
